package com.tuojun.blog.controller.admin;
...
import com.tuojun.blog.vo.BlogQuery;
...
public class BlogController {
    ...
    @GetMapping("/blogs")
    public String blogs(@PageableDefault(size = 3, sort = {"createTime"}, direction = Sort.Direction.DESC) Pageable pageable,
